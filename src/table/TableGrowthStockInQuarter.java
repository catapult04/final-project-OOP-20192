...
public class TableGrowthStockInQuarter extends JFrame {

    private JTable jt;

    public TableGrowthStockInQuarter(List<GrowthStock> growthList3) {
        setTitle("Bảng chỉ số cổ phiếu tăng trưởng mạnh trong quý");
